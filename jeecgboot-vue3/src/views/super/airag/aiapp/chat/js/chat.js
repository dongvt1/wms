...
(function () {
  ...
  const defaultConfig = {
    // Supports 'top-left' top-left, 'top-right' top-right, 'bottom-left' bottom-left, 'bottom-right' bottom-right
    iconPosition: 'bottom-right',
    // Icon size
    iconSize: '45px',
    // Icon color
    iconColor: '#155eef',
    // Required, not allowed to modify
    appId: '',
    // Chat popup width
    chatWidth: '800px',
    // Chat popup height
  ...
  function createAiChat(config) {
    ...
    //update-begin---author:wangshuai---date:2025-04-25---for:【QQYUN-12159】【AI Ad Space】Let users who need to build their own AI knowledge base know how to build their own AI knowledge base through Qiaoqiao Cloud---
    iframe.src = getIframeSrc(finalConfig) + '/ai/app/chat/' + finalConfig.appId + "?source=chatJs";
    //update-end---author:wangshuai---date:2025-04-25---for:【QQYUN-12159】【AI Ad Space】Let users who need to build their own AI knowledge base know how to build their own AI knowledge base through Qiaoqiao Cloud---
