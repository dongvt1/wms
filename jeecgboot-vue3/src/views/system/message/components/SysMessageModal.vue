  ...
  >
        ...
        <div class="icon-right">
          <div class="icons">
            <a-popover placement="bottomRight" :overlayStyle="{ width: '400px' }" trigger="click" v-model:open="showSearch">
              <template #content>
                <div>
                  <span class="search-label">reply、people who mentioned me?：</span>
    ...
    <div class="sys-message-card">
      <a-tabs :activeKey="activeKey" center @tabClick="handleChangePanel" animated>
        ...
        <a-tab-pane tab="All news" key="all" forceRender>
        ...
        <!-- mark star -->
        <a-tab-pane tab="Star news" key="star" forceRender>
  ...
  export default {
    ...
    setup(_p, {emit}) {
      ...
      const noticeTypeOption = reactive([
        { key: 'system', text: 'System notification', active: false, img: system },
        { key: 'flow', text: 'Process notification', active: false, img: flow },
        { key: 'plan', text: 'Schedule notification', active: false, img: calendar },
        { key: 'file', text: 'Knowledge notification', active: false, img: folder },
      ]);
      const noticeImg = ref('');
      ...
      const [registerModal, { closeModal }] = useModalInner(async (data) => {
        ...
        if(data.noticeType){
          ...
          //update-begin---author:wangshuai---date:2025-07-01---for:【QQYUN-12998】Click on the chat system icon，If you click the bell on the system again, no data will appear.---
          ...
          //update-end---author:wangshuai---date:2025-07-01---for:【QQYUN-12998】Click on the chat system icon，If you click the bell on the system again, no data will appear.---
          delete data.noticeType;
        }
        //Every time a pop-up window opens Load latest data
        loadData();
        if(data){
      ...
      function handleChangeSearchPerson(value, a) {
        console.log('Select to change', value, a);
      ...
      const dateTags = reactive([
        ...
        { key: 'qt', text: 'the day before yesterday', active: false },
        { key: 'bz', text: 'this week', active: false },
        { key: 'sz', text: 'last week', active: false },
        { key: 'by', text: 'this month', active: false },
        { key: 'sy', text: 'last month', active: false },
      ...
      function handleClickDateTag(item) {
        ...
        if (item.key == 'zdy') {
          // Customize日期查询走的是 handleChangeSearchDate
          if(item.active == false){
      ...
      // Display this string when there is a query condition value
