...
function statusColor(s: string) {
    const map: Record<string, string> = { draft: 'default', in_progress: 'blue', passed: 'green', failed: 'red', conditional: 'orange' };
    return map[s] || 'default';
}
function statusLabel(s: string) {
    const map: Record<string, string> = { draft: 'Nháp', in_progress: 'Đang KT', passed: 'Đạt', failed: 'Không đạt', conditional: 'Có điều kiện' };
    return map[s] || s;
}
</script>
