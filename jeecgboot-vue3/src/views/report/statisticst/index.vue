          ...
          <a-row>
            <a-col :span="10">
              <a-radio-group v-model:value="barType" @change="statisticst">
                <a-radio-button value="year">Yearly Statistics</a-radio-button>
                <a-radio-button value="month">Monthly Statistics</a-radio-button>
                <a-radio-button value="category">Category Statistics</a-radio-button>
                <a-radio-button value="cabinet">Cabinet Statistics</a-radio-button>
              </a-radio-group>
            </a-col>
          </a-row>
