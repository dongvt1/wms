          ...
          :actions="[
            {
              ...
              auth: 'other', // Control whether to display based on permissions: No permission，Don't show
            },
            {
              label: 'delete',
...
<script lang="ts">
  ...
  const columns: BasicColumn[] = [
    ...
    },
    {
      title: 'Name',
      dataIndex: 'name',
      auth: 'test', // Control whether to display based on permissions: No permission，Don't show
    },
    {
      title: 'state',
      dataIndex: 'status',
