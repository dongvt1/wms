<template>
  <PageWrapper title="File download example">
    <a-alert message="Download according to background interface file stream" />
    <a-button type="primary" class="my-4" @click="handleDownByData"> File streaming download </a-button>

    <a-alert message="Download files based on file address" />
    <a-button type="primary" class="my-4" @click="handleDownloadByUrl"> File address download </a-button>

    <a-alert message="base64streaming download" />
    <a-button type="primary" class="my-4" @click="handleDownloadByBase64"> base64streaming download </a-button>

    <a-alert message="pictureUrldownload,If there are cross-domain issues，需要处理picture跨域" />
    <a-button type="primary" class="my-4" @click="handleDownloadByOnlineUrl"> pictureUrldownload </a-button>
  </PageWrapper>
</template>
<script lang="ts">
