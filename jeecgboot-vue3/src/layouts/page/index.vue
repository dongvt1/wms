<template>
  <RouterView>
    <template #default="{ Component, route }">
      ...
      <template v-else>
        <!-- 【QQYUN-13593】Beautify blank pages -->
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      // update-begin--author:liaozhiyang---date:20250826---for:【QQYUN-13593】Beautify blank pages
      const { pageTip, getPageTip, effectVars } = useEmpty();
      // update-end--author:liaozhiyang---date:20250826---for:【QQYUN-13593】Beautify blank pages
      return {
        getTransitionName,
        openCache,
        getEnableTransition,
...
/** update-begin---author:liaozy ---date:2025-08-26  for：Beautify blank pages样式 */
.pageTip {
  display: flex;
...
/** update-end---author:liaozy ---date:2025-08-26  for：Beautify blank pages样式 */
</style>
