  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const showClassSideBarRef = computed(() => {
        // Control whether the sidebar is displayed
      ...
      // Using computational effort here may result insiderabnormal
      // andv After update，iftriggerSlot available，Then the code here can be discarded
