...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      // update-begin--author:liaozhiyang---date:20240417---for：【QQYUN-8927】Side fold navigation mode distinguishes color mode
      watch(
      ...
      // update-end--author:liaozhiyang---date:20240417---for：【QQYUN-8927】Side fold navigation mode distinguishes color mode
...
<style lang="less">
  ...
  .@{prefix-cls} {
    ...
    &.dark {
      ...
      // Side fold navigation color mode text color
      &.bright {
        .@{prefix-cls}-module {
          &__item {
            font-weight: normal;
