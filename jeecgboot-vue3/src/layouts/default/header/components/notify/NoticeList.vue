        ...
        <a-list-item-meta>
          ...
          <template #avatar>
            ...
            <template v-else-if="item.priority">
              <a-avatar v-if="item.priority === PriorityTypes.L" class="avatar priority-L" title="general news">
                <template #icon>
                  <Icon icon="entypo:info" />
                </template>
              </a-avatar>
              <a-avatar v-if="item.priority === PriorityTypes.M" class="avatar priority-M" title="important news">
                <template #icon>
                  <Icon icon="bi:exclamation-lg" />
                </template>
              </a-avatar>
              <a-avatar v-if="item.priority === PriorityTypes.H" class="avatar priority-H" title="emergency message">
                <template #icon>
