...
export function updateSidebarBgColor(color?: string) {
  ...
  // update-begin--author:liaozhiyang---date:20230811---for：【QQYUN-5922】logoBackground color gradient
  ...
  // update-end--author:liaozhiyang---date:20230811---for：【QQYUN-5922】llogoBackground color gradient
