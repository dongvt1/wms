...
export const treeProps = buildProps({
  ...
  // Custom data filtering judgment method(Note: Not the entire filtering method，It is a judgment method based on built-in filtering.，Used to enhance the original only throughtitleHow to filter)
  filterFn: {
