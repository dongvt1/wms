...
<script lang="ts" name="icon-list">
  ...
  export default defineComponent({
    ...
    setup(props, { emit }) {
      ...
      //Drop-down paging display
      const pageSizeOptions = ref<any>(['10', '20', '50', '100', '140']);
      //Drop down search value
      ...
      function handleSearchChange(e: ChangeEvent) {
        ...
        //update-begin---author:wangshuai ---date:20230522  for：【issues/4947】Menu edit page menu icon selection template，Display quantity per page switch is invalid------------
        setCurrentPage(1);
        current.value = 1;
        //update-end---author:wangshuai ---date:20230522  for：【issues/4947】Menu edit page menu icon selection template，No description of switching the number displayed per page------------
        if (!value) {
      ...
      //update-end---author:wangshuai ---date:20230522  for：【issues/4947】Menu edit page menu icon selection template，Display quantity per page switch is invalid，Click the icon behind the input box to clear the data.------------
      ...
      function handlePageChange(page: number, size: number) {
        ...
        pageSize.value = size;
        setPageSize(size);
        //update-end---author:wangshuai ---date:20230522  for：【issues/4947】Menu edit page menu icon selection template，Display quantity per page switch is invalid------------
        setCurrentPage(page);
      }
