  ...
  <div :class="prefixCls">
    <div v-show="!isEdit" :class="{ [`${prefixCls}__normal`]: true, 'ellipsis-cell': column.ellipsis }" @click="handleEdit">
      <div class="cell-content" :title="column.ellipsis ? getValues ?? '' : ''">
        <!-- update-begin--author:liaozhiyang---date:20240731---for：【issues/6957】editableCellThe component value length is0，Cannot edit -->
        <!-- update-begin--author:liaozhiyang---date:20240709---for：【issues/6851】editableCellThe component value is0Not shown -->
        {{ typeof getValues === 'string' && getValues.length === 0 ? '&nbsp;' : getValues ?? '&nbsp;' }}
        <!-- update-end--author:liaozhiyang---date:20240709---for：【issues/6851】editableCellThe component value is0Not shown -->
        <!-- update-end--author:liaozhiyang---date:20240731---for：【issues/6957】editableCellThe component value length is0，Cannot edit -->
      </div>
  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      const getComponentProps = computed(() => {
        ...
        //update-begin---author:wangshuai---date:2024-09-19---for:【issues/7136】on the celltooltiphint，If the table has scroll bars，Will it not scroll with the cell?---
        ...
        //update-end---author:wangshuai---date:2024-09-19---for:【issues/7136】on the celltooltiphint，If the table has scroll bars，Will it not scroll with the cell?---
        return {
          size: 'small',
          //update-begin---author:wangshuai---date:2024-09-19---for:【issues/7136】on the celltooltiphint，If the table has scroll bars，Will it not scroll with the cell?---
      ...
      const getValues = computed(() => {
        ...
        // update-begin---author:liaozhiyang---date:2025-07-28---for:【QQYUN-13251】Table editable cellsapiSelectMultiple selection without translation ---
        ...
        // update-end---author:liaozhiyang---date:2025-07-28---for:【QQYUN-13251】Table editable cellsapiSelectMultiple selection without translation ---
