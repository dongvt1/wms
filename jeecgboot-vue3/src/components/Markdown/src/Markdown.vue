...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup(props, { attrs, emit }) {
      console.log("---Markdown---initialization---")
      ...
      //update-begin-author:taoyan date:2022-5-24 for: VUEN-1090 markdown Unable to upload
      ...
      //update-end-author:taoyan date:2022-5-24 for: VUEN-1090 markdown Unable to upload
      function init() {
        const wrapEl = unref(wrapRef) as HTMLElement;
        if (!wrapEl) return;

        // vditorComponent localization path configuration【QQYUN-12053】
        ...
        const insEditor = new Vditor(wrapEl, {
          ...
          // update-begin--author:liaozhiyang---date:20240520---for：【TV360X-146】MarkdownRemove the recording option from the component
          toolbar: [
            'emoji',
            'headings',
            'bold',
          ...
          // update-end--author:liaozhiyang---date:20240520---for：【TV360X-146】MarkdownRemove the recording option from the component
          mode: 'sv',
          ...
          upload: {
            ...
            // Traverse files, upload and display
            async handler(files) {
...
<style lang="less" scoped>
  // update-begin--author:liaozhiyang---date:20240527---for：【TV360X-318】solvemarkdownThe magnification button can also be clicked in the disabled state of the control
  :deep(.vditor-menu--disabled) {
    pointer-events: none;
  }
  // update-end--author:liaozhiyang---date:20240527---for：【TV360X-318】solvemarkdownThe magnification button can also be clicked in the disabled state of the control
</style>
