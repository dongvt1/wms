  ...
  export default defineComponent({
    ...
    setup(props, { emit, refs }) {
      ...
      watch(
        ...
        //update-begin---author:wangshuai---date:2024-06-17---for:【TV360X-480】Encapsulated forms and native forms，Default values ​​generate problematic fields：Classification dictionary tree with default value does not take effect---
        { deep: true, immediate: true }
        //update-end---author:wangshuai---date:2024-06-17---for:【TV360X-480】Encapsulated forms and native forms，Default values ​​generate problematic fields：Classification dictionary tree with default value does not take effect---
      );
      watch(
        () => props.pcode,
        () => {
