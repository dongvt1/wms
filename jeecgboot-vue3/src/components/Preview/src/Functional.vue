  ...
  export default defineComponent({
    ...
    setup(props, { expose, emit }) {
      ...
      function initMouseWheel() {
        ...
        // Firefox does not haveonmousewheelevent，useDOMMouseScrollreplace
        document.body.addEventListener('DOMMouseScroll', scrollFunc);
        // 禁止火狐浏览器下拖拽图片的默认event
      ...
      function scaleFunc(num: number) {
        ...
        // update-begin--author:liaozhiyang---date:20250722---for：【QQYUN-13162】Click on the image preview to zoom it out and it will disappear.
        if (imgState.imgScale < 0.2) {
          imgState.imgScale = 0.2;
        }
        // update-end--author:liaozhiyang---date:20250722---for：【QQYUN-13162】Click on the image preview to zoom it out and it will disappear.
      }
        ...
        img.onload = (e: Event) => {
          if (imgState.currentUrl !== url) {
            ...
            if (props.rememberState) {
              // Save the zoom information of the current image
              ...
              // If scaling information has been stored previously，就应use
      ...
      function close() {
        ...
        // Restore Firefox andSafariDrag and drop pictures in the browser
