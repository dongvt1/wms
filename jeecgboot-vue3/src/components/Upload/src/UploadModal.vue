  ...
  export default defineComponent({
    ...
    setup(props, { emit }) {
      ...
      function beforeUpload(file: File) {
        ...
        // Set maximum value，Then judge
        if (maxSize && file.size / 1024 / 1024 >= maxSize) {
          createMessage.error(t('component.upload.maxSizeMultiple', [maxSize]));
          return false;
        }

        // Setting type,Then judge
        ...
        if (checkImgType(file)) {
          // beforeUpload，If it is asynchronous, the built-in upload method will be called.
      ...
      async function handleStartUpload() {
        ...
        try {
          ...
          // Only uploading is not successful.
          ...
          // production environment:throw error
