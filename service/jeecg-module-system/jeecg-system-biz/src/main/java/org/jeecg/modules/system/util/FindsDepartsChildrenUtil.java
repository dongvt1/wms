...
/**
 * <P>
 * Table of corresponding departments,Process and find tree-level data
 * <P>
 * 
 * @Author: Steve
 * @Date: 2019-01-22
...
public class FindsDepartsChildrenUtil {
	...
	//Department tree information-tree structure
	//private static List<SysDepartTreeModel> sysDepartTreeList = new ArrayList<SysDepartTreeModel>();
	
	//department treeid-tree structure
    //private static List<DepartIdModel> idList = new ArrayList<>();


    /**
     * queryTreeListsubmethod ====1=====
     * The method issWillSysDeparttypelistSet converted toSysDepartTreeModeltypegather
     */
    public static List<SysDepartTreeModel> wrapTreeDataToTreeList(List<SysDepart> recordList) {
        // Once per request in this method,It’s all about the overall situationlistCollection for cleaning
        //idList.clear();
    ...
    /**
     * queryTreeListsubmethod ====2=====
     * The method is找到并封装顶级父类的节点到TreeListgather
     */
    ...
    /**
     * queryTreeListsubmethod====3====
     *The method is找到顶级父类下的所有子节点gather并封装到TreeListgather
     */
    ...
    /**
     * queryTreeListsubmethod ====4====
     * The method isWill子节点为空的Listgather设置为Nullvalue
     */
