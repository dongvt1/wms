...
/**
 * Enterfallbackmethod Check iftokennot set
 * @author: jeecg-boot
 */
@Slf4j
public class SysBaseAPIFallback implements ISysBaseAPI {
    ...
    public String parseTemplateByCode(TemplateDTO templateDTO) {
        log.error("Failed to obtain message content through template {}", cause);
        return null;
    }
    ...
    public List<DictModel> queryAllDict() {
        log.error("fegininterfacequeryAllDictfail："+cause.getMessage(), cause);
        return null;
    }
    ...
    public List<String> queryTableDictByKeys(String table, String text, String code, String[] keyArray) {
        log.error("queryTableDictByKeys查询fail {}", cause);
        return null;
    }
    ...
    public LoginUser getUserByName(String username) {
        log.error("jeecg-systemThe service node is unavailable，导致获取登录用户信息fail： " + cause.getMessage(), cause);
        return null;
    }
