...
public class MockController {
	...
	/**
	 * UniversaljsonAccess interface
	 * Format： http://localhost:8080/jeecg-boot/api/json/{filename}
	 * @param filename
	 * @return
	 */
	...
	/**
	 * Old login interface to obtain user information
	 * @return
	 */
	...
	//-------------------------------------------------------------------------------------------
	/**
	 * Data on the workbench home page
	 * @return
	 */
	...
	//author:lvdandan-----date：20190315---for:Add data logjson----
    /**
     * Data log
     */
	...
	//--update-begin--author:wangshuai-----date：20201023---for:Return user informationjsondata----
    /**
     * User information
     */
	...
	//--update-end--author:wangshuai-----date：20201023---for:Return user informationjsondata----
	/**
	 * readjsonFormat文件
	 * @param jsonSrc
	 * @return
	...
	private String readJson(String jsonSrc) {
		...
		try {
			...
			//换indivual写法，solvespringbootreadjarProblem with files in package
