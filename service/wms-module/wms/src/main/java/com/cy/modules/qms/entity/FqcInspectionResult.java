...
/**
 * @Description: Kết quả từng tiêu chí kiểm tra FQC
 * @Author: BMad
 * @Date: 2026-02-25
 * @Version: V1.0
 */
...
@Schema(description = "Kết quả từng tiêu chí kiểm tra FQC")
@TableName("qms_fqc_inspection_result")
public class FqcInspectionResult implements Serializable {
    ...
    @Schema(description = "ID phiếu FQC")
