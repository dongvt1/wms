...
/**
 * @Description: Kết quả từng tiêu chí kiểm tra PQC
 * @Author: BMad
 * @Date: 2026-02-25
 * @Version: V1.0
 */
...
@Schema(description = "Kết quả từng tiêu chí kiểm tra PQC")
@TableName("qms_pqc_inspection_result")
public class PqcInspectionResult implements Serializable {
    ...
    @Schema(description = "ID phiếu PQC")
