...
/**
 * @Description: Phiên bản BOM (BOM Revision) – Common Entity
 * @Author: BMad
 * @Date: 2026-03-02
 * @Version: V1.0
 */
...
@TableName("pl_bom_revision")
public class BomRevision extends JeecgEntity {
    ...
    /** FK tới pl_ecn.id nếu tạo từ ECN */
    @Schema(description = "FK tới pl_ecn.id nếu tạo từ ECN")
