...
/**
 * @Description: Định mức nguyên vật liệu (BOM) – Common Entity (dùng chung cho tất cả module)
 * @Author: BMad
 * @Date: 2026-03-02
 * @Version: V1.0
 */
...
@TableName("pl_bom")
public class Bom extends JeecgEntity {
    ...
    /** Tên thành phẩm (transient – join query) */
    @Schema(description = "Tên thành phẩm")
    ...
    /** BOM mặc định cho sản phẩm */
    @Schema(description = "BOM mặc định cho sản phẩm (true/false)")
