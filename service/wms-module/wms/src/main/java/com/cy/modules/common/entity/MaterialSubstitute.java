...
/**
 * @Description: Linh kiện thay thế của nguyên vật liệu (toàn cục)
 * @Author: BMad
 * @Date: 2026-03-05
 * @Version: V1.0
 */
...
@Schema(description = "Linh kiện thay thế của vật tư (toàn cục)")
@TableName("material_substitute")
public class MaterialSubstitute implements Serializable {
    ...
    /** ID vật tư gốc */
    @Schema(description = "ID vật tư gốc (FK → material.id)")
