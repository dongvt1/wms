...
/**
 * @Description: Sản phẩm – Common Entity (dùng chung cho tất cả module)
 * @Author: BMad
 * @Date: 2026-03-02
 * @Version: V1.0
 */
...
@TableName("product")
public class Product extends JeecgEntity {
    ...
    /** Tên danh mục (transient – join query) */
    ...
    /** Loại: product (thành phẩm), material (nguyên vật liệu), semi (bán thành phẩm) */
    @Excel(name = "Loại", width = 15)
    @Schema(description = "Loại: product | material | semi")
    private String type;
}
