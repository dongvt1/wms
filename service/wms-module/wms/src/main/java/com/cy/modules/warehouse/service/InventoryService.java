...
public interface InventoryService extends IService<Inventory> {
     ...
     */
    boolean updateInventoryQuantity(String productId, Integer quantity, Integer reservedQuantity,Integer availableQuantity, String updatedBy);
     ...
     * @param productId Product ID
     * @param delta Amount to adjust (positive = add stock, negative = deduct stock)
     * @param reason Reason for adjustment
     * @return Result message containing "successfully" on success
     */
    String adjustInventory(String productId, Integer delta, String reason);
}