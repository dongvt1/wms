...
--
-- Table structure for table `sys_user_dep_post`
--
...
CREATE TABLE `sys_user_dep_post` (
  ...
  `dep_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'departmentpostid',
...
--
-- Dumping data for table `sys_user_dep_post`
--

LOCK TABLES `sys_user_dep_post` WRITE;
/*!40000 ALTER TABLE `sys_user_dep_post` DISABLE KEYS */;
/*!40000 ALTER TABLE `sys_user_dep_post` ENABLE KEYS */;
UNLOCK TABLES;
