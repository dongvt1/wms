...
CREATE TABLE `joa_demo` (
  ...
  `name` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '请假people',
  `days` int DEFAULT NULL COMMENT '请假sky数',
  `begin_date` datetime DEFAULT NULL COMMENT 'starthour间',
  `end_date` datetime DEFAULT NULL COMMENT '请假Finishhour间',
  `reason` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT 'Reason for leave',
  `bpm_status` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT '1' COMMENT 'processstate',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='processtest';
