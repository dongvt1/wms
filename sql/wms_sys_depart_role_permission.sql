...
CREATE TABLE `sys_depart_role_permission` (
  ...
  `data_rule_ids` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT 'dataPermissionsids',
  `operate_date` datetime DEFAULT NULL COMMENT 'operatehour间',
  `operate_ip` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT 'operateip',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='departmentRolePermissionssurface';
