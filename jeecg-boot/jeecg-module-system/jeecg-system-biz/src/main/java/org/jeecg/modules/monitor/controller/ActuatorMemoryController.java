...
public class ActuatorMemoryController {
    ...
    public Result<?> getRedisInfo() {
		...
		//update-begin---author:chenrui ---date:20240705  for：[TV360X-1695]memory information-Update now Function error #6635------------
...
//			JSONObject operatingSystemJson = JSONObject.parseObject(JSONObject.toJSONString(operatingSystemMXBean));
		...
		//update-end---author:chenrui ---date:20240705  for：[TV360X-1695]memory information-Update now Function error #6635------------
