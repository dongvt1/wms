...
public class OpenApiController extends JeecgController<OpenApi, OpenApiService> {
    ...
    /**
     * Generate interface access token Token
     *
     * @param USERNAME
     * @param PASSWORD
     * @return
    ...
    private void pathsAndDefinitions(SwaggerModel swaggerModel) {
        ...
        for (OpenApi openApi : openapis) {
            ...
            if (StringUtils.hasText(openApi.getBody())) {
                ...
                // bodyofdefinitionBuild completed
            ...
            codeProperties.setDescription("return code");
            ...
            messageProperties.setDescription("Return to processing message");
            ...
            resultProperties.setDescription("Return data object");
            ...
            successProperties.setDescription("success sign");
            ...
            timestampProperties.setDescription("Timestamp");
    ...
    private SwaggerInfo swaggerInfo() {
        ...
        info.setDescription("OpenAPI interface list");
        info.setVersion("3.8.3");
        info.setTitle("OpenAPI interface list");
