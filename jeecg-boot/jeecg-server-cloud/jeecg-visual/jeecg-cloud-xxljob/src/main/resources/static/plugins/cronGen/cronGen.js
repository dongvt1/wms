(function ($) {
    ...
    $.fn.extend({
        cronGen: function (options) {
            ...
            $('<li/>').html($('<a id="MonthlyTab" href="#Monthly">moon</a>')).appendTo(topMenu);
            ...
            var runTime = '<br style="padding-top: 10px"><label>Last running time: </label></br><textarea id="runTime" rows="6" style="width: 90%;resize: none;background: none;border: none;outline: none;" readonly = readonly></textarea></div>';
            ...
            // Add an input
            var $i = $("<input>", { type: 'text', placeholder: 'cronexpression...', name: 'cronGen_display' }).addClass("form-control").val($(that).val());
            $i.appendTo($g);
            // Add the button
