...
$(function () {
    ...
    $('#filterTime').daterangepicker({
        ...
        showDropdowns:false,        // Whether to display year and month selection conditions
        timePicker: true, 			// Whether to display hour and minute selection criteria
        timePickerIncrement: 10, 	// time increment，Unit is minutes
        timePicker24Hour : true,
        opens : 'left', //The pop-up position of the date selection box
        ranges: rangesConf,
        locale : {
            ...
            daysOfWeek : I18n.daterangepicker_custom_daysofweek.split(',') ,        // 'day', 'one', 'two', 'three', 'Four', 'five', 'six'
            monthNames : I18n.daterangepicker_custom_monthnames.split(',') ,        // 'one月', 'two月', 'three月', 'Four月', 'five月', 'six月', 'July', 'August', 'September', 'October', '十one月', '十two月'
            firstDay : 1
        },
