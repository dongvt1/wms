...
/**
 * @author zyf
 * @description Override hotspot rule entity class,。Checksentinel-dashboardIn customizationParamFlowRuleNacosPublisherwhen The pushed data isParamFlowRuleEntity。 Received by the clientParamFlowRulekind
 * @date 2022-04-13
 */
