...
public class JeecgSentinelApplication {
    ...
    public static void main(String[] args) {
        ...
        // at presentjeecg-sentinel 1.8.3 version existsalibaba-sentinel 1.8.3Version start upnacosThe data source causes the configuration to not take effect，The following are temporary solutions
