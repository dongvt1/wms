...
/**
 * Gateway current limiting rule controller
 *
 * @author zyf
 * @date 2022-04-13
 */
...
public class GatewayFlowRuleController extends BaseRuleController {
    ...
    public Result<GatewayFlowRuleEntity> addFlowRule(@RequestBody AddFlowRuleReqVo reqVo) {
        ...
        if (paramItem != null) {
            ...
            // Parameter properties 0-ClientIP 1-Remote Host 2-Header 3-URLparameter 4-Cookie
            ...
            // 当Parameter properties为2-Header 3-URLparameter 4-Cookiehour，parameternameRequired
            ...
            // If the matching string is not empty，Verify matching pattern
        ...
        // thresholdtype 0-Number of threads 1-QPS
        ...
        // flow control method 0-fail fast 2-Queuing up at a constant speed
        ...
        if (CONTROL_BEHAVIOR_DEFAULT == controlBehavior) {
            // 0-fail fast, butBurst sizeRequired
            ...
            // 1-Queuing up at a constant speed, but超hourhour间Required
    ...
    public Result<GatewayFlowRuleEntity> updateFlowRule(@RequestBody UpdateFlowRuleReqVo reqVo) {
        ...
        if (CONTROL_BEHAVIOR_DEFAULT == controlBehavior) {
            ...
            // 2-Queuing up at a constant speed, but超hourhour间Required
            Integer maxQueueingTimeoutMs = reqVo.getMaxQueueingTimeoutMs();
            if (maxQueueingTimeoutMs == null) {
                return Result.ofFail(-1, "maxQueueingTimeoutMs can't be null");
            }
