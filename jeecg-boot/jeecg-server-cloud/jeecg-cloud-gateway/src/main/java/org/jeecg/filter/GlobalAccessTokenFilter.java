...
/**
* global interceptor，Acts on all microservices
*
* 1.rewriteStripPrefix(get realURL)
* 2.change the currentrequest，Add current identity
* @author: scott
* @date: 2022/4/8 10:55
*/
@Slf4j
...
public class GlobalAccessTokenFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        //update-begin---author:chenrui ---date:20240603  for：There is no port in the address(http/httpsdefault)hourportyes-1------------
        String basePath = scheme + "://" + host;
        if (port != -1) {
            basePath += ":" + port;
        }
        //update-end---author:chenrui ---date:20240603  for：There is no port in the address(http/httpsdefault)hourportyes-1------------
        // 1. rewriteStripPrefix(get realURL)
