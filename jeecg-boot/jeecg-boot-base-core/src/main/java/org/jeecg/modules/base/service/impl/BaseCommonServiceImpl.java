...
/**
 * @Description: commonImplementation class
 * @author: jeecg-boot
 */
@Service
@Slf4j
public class BaseCommonServiceImpl implements BaseCommonService {
    ...
    public void addLog(LogDTO logDTO) {
        ...
        //save log（Exception catching and handling，Prevent storage failure when data is too large，leading to business failure）JT-238
        try {   
    ...
    public void addLog(String logContent, Integer logType, Integer operatetype, LoginUser user) {
        ...
        //Description on the annotation,Operation log content
