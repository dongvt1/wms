 ...
 * Startup program modificationDruidWallConfigConfiguration
 * allowSELECTstatementWHEREclause is a forever true condition
 * @author eightmonth
 * @date 2024/4/8 11:37
 */
public class DruidWallConfigRegister implements SpringApplicationRunListener {
    ...
    /**
     * Essential，Otherwise, an error will be reported at startup
     * @param application
     * @param args
     */
