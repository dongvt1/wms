<template>
  <PageWrapper title="MarkDownComponent example">
    <div>
      ...
      <MarkDown v-model:value="value" @change="handleChange" ref="markDownRef" placeholder="This is placeholder text" />
    </div>
    <div class="mt-2">
      <a-card title="Markdown Viewer Component demo">
