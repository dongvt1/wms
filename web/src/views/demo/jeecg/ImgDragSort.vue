<template>
  <div>
    <draggable @end="end" v-model="dataArr" item-key="id" style="display: flex">
      ...
      <template #footer>
        <a-button @click="sureChange" type="primary" style="margin-top: 100px">Sure</a-button>
      </template>
    </draggable>
    <a-divider>jsondata</a-divider>
    <a-row>
      <a-col :span="12">
        <p>Before dragging：</p>
...
<script lang="ts" setup>
  ...
  const mockData = [
    ...
    { id: '333', sort: 3, filePath: 'https://static.jeecg.com/temp/Guoju Softwarelogo_1606575029126.png' },
   ...
   */
  function end(evt) {
    console.log('Position before dragging' + evt.oldIndex);
    console.log('Position after dragging' + evt.newIndex);
  }
