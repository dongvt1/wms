        ...
        <a-tab-pane tab="Customer information" key="1">
          <vxe-toolbar>
            <template #buttons>
              ...
              <vxe-button @click="$refs.xTable.removeCheckboxRow()">Remove selected</vxe-button>
            </template>
          </vxe-toolbar>
          ...
          >
            ...
            <vxe-column field="idcard" title="ID card" sortable :edit-render="{ name: 'input', defaultValue: '' }"></vxe-column>
            <vxe-column field="telphone" title="cell phone" sortable :edit-render="{ name: 'input', defaultValue: '' }"></vxe-column>
          </vxe-table>
        </a-tab-pane>

        <a-tab-pane tab="Air ticket information" key="2" forceRender> </a-tab-pane>
      </a-tabs>
    </a-form>
  </BasicModal>
</template>
