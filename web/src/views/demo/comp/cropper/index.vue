<template>
  <PageWrapper title="Image cropping example" content="The test interface service needs to be enabled to perform upload testing.！">
    ...
    <CollapseContainer title="Rectangle crop" class="my-4">
      ...
      <p v-if="cropperImg">Image information after cropping：{{ info }}</p>
    </CollapseContainer>
    ...
    <CollapseContainer title="round cut">
      ...
      <p v-if="circleImg">Image information after cropping：{{ circleInfo }}</p>
    </CollapseContainer>
  </PageWrapper>
</template>
<script lang="ts">
