  ...
  <div :class="prefixCls">
    <a-row :class="`${prefixCls}-top`">
        ...
        <a-row>
          <a-col :span="8">
            <div :class="`${prefixCls}-top__avatar`">
              ...
              <span>Jeecg</span>
              <div>Tolerant of all rivers，Tolerance is great</div>
            </div>
          </a-col>
          <a-col :span="16">
      ...
      <a-col :span="7" :class="`${prefixCls}-col`">
        <CollapseContainer title="Label" :canExpan="false">
      ...
      <a-col :span="8" :class="`${prefixCls}-col`">
        <CollapseContainer :class="`${prefixCls}-top__team`" title="team" :canExpan="false">
