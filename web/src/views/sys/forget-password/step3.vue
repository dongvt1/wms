<template>
  <Result status="success" title="Password changed successfully" :sub-title="getSubTitle">
    <template #extra>
      <a-button key="console" type="primary" @click="finish"> Return to login </a-button>
    </template>
  </Result>
</template>
<script lang="ts">
