...
<script lang="ts" setup>
  ...
  function sendCodeApi() {
    //update-begin---author:wangshuai---date:2025-07-15---for:【issues/8567】serious：There is a horizontal override problem when changing passwords：Log in应该用Log in模板不应该用忘记密码的模板---
    return getCaptcha({ mobile: formData.mobile, smsmode: SmsEnum.LOGIN });
    //update-end---author:wangshuai---date:2025-07-15---for:【issues/8567】serious：There is a horizontal override problem when changing passwords：Log in应该用Log in模板不应该用忘记密码的模板---
  }
</script>
