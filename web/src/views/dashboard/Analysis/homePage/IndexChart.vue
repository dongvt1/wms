<template>
  <div class="p-4">
    ...
    <a-row>
      <a-col :span="24">
        <a-card :loading="loading" :bordered="false" title="Visit statistics for the past week">
          <div class="infoArea">
            <HeadInfo title="todayIP" :iconColor="ipColor" :content="loginfo.todayIp" icon="environment"></HeadInfo>
            <HeadInfo title="today访问" :iconColor="visitColor" :content="loginfo.todayVisitCount" icon="team"></HeadInfo>
            <HeadInfo title="total visits" :iconColor="seriesColor" :content="loginfo.totalVisitCount" icon="rise"></HeadInfo>
          </div>
