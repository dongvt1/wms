                ...
                <div class="aui-account aui-account-line">
                  ...
                  <a-form-item>
                    <div class="aui-input-line">
                      ...
                      <div class="aui-eye">
                        <img :src="eyeKImg" alt="turn on" v-if="pwdIndex==='open'"  @click="pwdClick('close')" />
                        <img :src="eyeGImg" alt="closure"  v-else-if="pwdIndex==='close'"  @click="pwdClick('open')" />
                      </div>
                    </div>
                  </a-form-item>
                  <a-form-item>
                    <div class="aui-input-line">
                      ...
                      <div class="aui-eye">
                        <img :src="eyeKImg" alt="turn on" v-if="confirmPwdIndex==='open'" @click="confirmPwdClick('close')" />
                        <img :src="eyeGImg" alt="closure" v-else-if="confirmPwdIndex==='close'" @click="confirmPwdClick('open')" />
                      </div>
                    </div>
                  </a-form-item>
