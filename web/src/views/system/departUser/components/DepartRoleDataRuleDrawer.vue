<template>
  <BasicDrawer title="Data rules/Button permission configuration" :width="365" @close="onClose" @register="registerDrawer">
    <a-spin :spinning="loading">
      <a-tabs defaultActiveKey="1">
        <a-tab-pane tab="Data rules" key="1">
          ...
          <a-empty v-else description="No configuration information" />
        </a-tab-pane>
        <!--<a-tab-pane tab="Button permissions" key="2">Stay tuned!!!</a-tab-pane>-->
      </a-tabs>
    </a-spin>
  </BasicDrawer>
</template>
