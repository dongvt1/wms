/**
 * Determine whether Hexadecimal color value.
...
/**
 * RGB Color values ​​are converted to Hexadecimal color value.
 * r, g, and b need to be in [0, 255] within range
 *
 * @return  String          similar#ff00ff
 * @param r
 * @param g
 * @param b
 */
