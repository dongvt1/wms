      ...
      <template #rightExtra v-if="getShowRedo || getShowQuick">
        <div class="rightExtra">
          ...
          <router-link to="/ai" class="ai-icon">
            <a-tooltip title="AIassistant" placement="left">
...
.@{prefix-cls} {
  ...
  // update-begin--author:liaozhiyang---date:20241016---for：【issues/7345】The label style is switched to minimalist mode and the style is messed up
  .rightExtra {
    display: flex;
    :deep(svg) {
      &:not(.icon) {
  ...
  // update-end--author:liaozhiyang---date:20241016---for：【issues/7345】The label style is switched to minimalist mode and the style is messed up
}
</style>
