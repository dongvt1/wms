...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      /**
       * Home page multi-tenant department pop-up window logic
       */
      const loginSelectRef = ref();

      function showLoginSelect() {
        //update-begin---author:liusq  Date:20220101  for：Determine whether logging in requires a pop-up window to select a tenant.----
        //Determine whether you are logged in
        const loginInfo = toRaw(userStore.getLoginInfo) || {};
        if (!!loginInfo.isLogin) {
          loginSelectRef.value.show(loginInfo);
        }
        //update-end---author:liusq  Date:20220101  for：Determine whether logging in requires a pop-up window to select a tenant.----
      }
...
<style lang="less">
  @import './index.less';
  //update-begin---author:scott ---date:2022-09-30  for：Top menu breadcrumbs hidden by default-----------
  //顶部Welcome展示样式
  ...
  .ant-layout .@{prefix-cls} {
    display: flex;
    padding: 0 8px;
    // update-begin--author:liaozhiyang---date:20240407---for：【QQYUN-8762】top rail height
    height: @header-height;
    // update-end--author:liaozhiyang---date:20240407---for：【QQYUN-8762】top rail height
    align-items: center;
    ...
    //update-end---author:scott ---date::2022-09-30  for：Top menu breadcrumbs hidden by default--------------
  }
</style>
