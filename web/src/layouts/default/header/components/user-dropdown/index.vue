...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      /**
       * Multi-department pop-up window logic
       */
      const loginSelectRef = ref();
      // update-begin--author:liaozhiyang---date:20230901---for：【QQYUN-6333】Null routing problem—The resource being accessed for the first time is too large
      async function handleLock() {
        await getRefPromise(lockActionRef);
        openModal(true);
      }
      // update-end--author:liaozhiyang---date:20230901---for：【QQYUN-6333】Null routing problem—The resource being accessed for the first time is too large
      //  login out
      ...
      async function clearCache() {
        ...
        if (result.success) {
          ...
          // update-begin--author:wangshuai---date:20241112---for：【issues/7433】vue3 Data dictionary optimization suggestions
          userStore.setAllDictItems(res.result);
          // update-end--author:wangshuai---date:20241112---for：【issues/7433】vue3 Data dictionary optimization suggestions
        } else {
          // update-begin--author:liaozhiyang---date:20240124---for：【QQYUN-7970】internationalization
      ...
      function handleMenuClick(e: { key: MenuEvent }) {
        switch (e.key) {
          ...
          case 'password':
            ...
            break;
          case 'account':
            //update-begin---author:wangshuai ---date:20221125  for：Enter the user settings page------------
            go(`/system/usersetting`);
            //update-end---author:wangshuai ---date:20221125  for：Enter the user settings page--------------
            break;
        }
      }
...
<style lang="less">
  ...
  .@{prefix-cls} {
    ...
    &-dropdown-overlay {
      // update-begin--author:liaozhiyang---date:20231226---for：【QQYUN-7512】The position of the top account will change when it pops up for the first time.
      width: 160px;
      // update-end--author:liaozhiyang---date:20231226---for：【QQYUN-7512】The position of the top account will change when it pops up for the first time.
      .ant-dropdown-menu-item {
        min-width: 160px;
      }
    }
  }
  // update-begin--author:liaozhiyang---date:20250702---for：【QQYUN-13013】Switch to English mode drop-down menu width is a bit narrow
  html[lang="en"] {
    .@{prefix-cls} {
      &-dropdown-overlay {
        width: 175px;
  ...
  // update-end--author:liaozhiyang---date:20250702---for：【QQYUN-13013】Switch to English mode drop-down menu width is a bit narrow
</style>
