  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      const getUseScroll = computed(() => {
        // 【JEECGAs Qiankunzi application】Under the application of Qiankunzi，The menu is not fixed
      ...
      const getWrapperStyle = computed((): CSSProperties => {
        return {
          // update-begin--author:liaozhiyang---date:20241216---for：【issues/7548】In sidebar navigation mode, the menu below will not be fully scrolled.
          height: `calc(100% - ${unref(getIsShowLogo) ? '60px' : '0px'})`,
          // update-end--author:liaozhiyang---date:20241216---for：【issues/7548】In sidebar navigation mode, the menu below will not be fully scrolled.
        };
      });
...
<style lang="less" scoped>
  // update-begin--author:liaozhiyang---date:20230803---for：【QQYUN-5872】Menu optimization，Remove the up and down scroll bars
  .scroll-container :deep(.scrollbar__bar) {
    display: none;
  }
  // update-end--author:liaozhiyang---date:20230803---for：【QQYUN-5872】Menu optimization，Remove the up and down scroll bars
</style>
<style lang="less">
