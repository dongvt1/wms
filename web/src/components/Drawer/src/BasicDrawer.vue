  ...
  export default defineComponent({
    ...
    setup(props, { emit }) {
      ...
      const getMergeProps = computed((): DrawerProps => {
        // update-begin--author:liaozhiyang---date:20240320---for：【QQYUN-8389】vue3.4The above version causes the character drawer to be hiddenfooterlogic error（toRawChange tocloneDeep，otherwisepropschanges will not triggercomputed）
        return { ...deepMerge(cloneDeep(props), unref(propsRef)) };
        // update-end--author:liaozhiyang---date:20240320---for：【QQYUN-8389】vue3.4The above version causes the character drawer to be hiddenfooterlogic error（toRawChange tocloneDeep，otherwisepropschanges will not triggercomputed）
      });
