  ...
  export default defineComponent({
    ...
    setup(props, { attrs, emit }) {
      ...
      async function handleSelect(key: string) {
        ...
        // update-begin--author:liaozhiyang---date:20240227---for：【QQYUN-6366】Internal routing can also support adoption of new browserstabOpen
        const findItem = getMatchingMenu(props.items, key);
        if (findItem?.internalOrExternal == true) {
          window.open(location.origin + key);
          return;
        }
        // update-end--author:liaozhiyang---date:20240227---for：【QQYUN-6366】Internal routing can also support adoption of new browserstabOpen
