...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    props: {
      ...
      // update-begin--author:liaozhiyang---date:20240417---for:【QQYUN-8927】Text color adjustment in color mode of sidebar navigation secondary menu
      isThemeBright: {
        type: Boolean,
        default: false,
      },
      // update-end--author:liaozhiyang---date:20240417---for:【QQYUN-8927】Text color adjustment in color mode of sidebar navigation secondary menu
    },
    setup(props) {
      ...
      const getOverlayStyle = computed((): CSSProperties => {
        // update-begin--author:liaozhiyang---date:20240407---for：【QQYUN-8774】Side hybrid navigation menu width adjustment
        return {
          minWidth: '150px',
        };
        // update-end--author:liaozhiyang---date:20240407---for：【QQYUN-8774】Side hybrid navigation menu width adjustment
      });
