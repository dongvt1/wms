...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    props: {
      ...
      // Whether to display simply（Show only the first image）
      simpleShow: propTypes.bool,
      // Whether to display the number of pictures in simple modebadge
      showBadge: propTypes.bool.def(true),
      // Picture spacing
      margin: propTypes.number.def(4),
      // srcprefix，will be appended toimgListbefore each item
