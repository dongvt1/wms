  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      function handleTitleClick({ key }: { key: SizeType }) {
        ...
        // update-begin--author:liaozhiyang---date:20240604---for：【TV360X-100】cache table density
        $ls.set(cacheKey.value, key);
        // update-end--author:liaozhiyang---date:20240604---for：【TV360X-100】cache table density
      }
      // update-begin--author:liaozhiyang---date:20240604---for：【TV360X-100】cache table density
